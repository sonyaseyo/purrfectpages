...
Contact3.defaultProps = {
  content2: "We'd love to hear from you.",
  content1:
    'Have a question or just want to say meow? Feel free to reach out to us!',
  content5:
    'Sign up for our newsletter to stay up-to-date with all things cozy reading and cats.',
  heading1: 'Contact Us',
  content3:
    'Follow us on social media for the latest updates and purrfect book recommendations.',
  content4: 'Join our community of book-loving cat enthusiasts today!',
  address1: '123 Cozy Reading Street, Bookland',
  phone1: '+1-234-567-8901',
  email1: 'info@cozyreadingcats.com',
}
