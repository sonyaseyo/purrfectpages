...
Contact4.defaultProps = {
  email1: 'contact@cozycatreads.com',
  content2:
    'You can also follow us on social media for the latest updates and cozy cat reading recommendations.',
  content3:
    'Join our mailing list for exclusive offers and purr-fect book suggestions.',
  content1:
    "We'd love to hear from you! Feel free to reach out to us for any inquiries or just to say hello.",
  address1: '123 Cozy Cat Lane, Meowtown, USA',
  content5:
    'We value your feedback and suggestions. Let us know how we can make your reading experience even cozier!',
  content4:
    'For any press or collaboration inquiries, please contact us at press@cozycatreads.com',
